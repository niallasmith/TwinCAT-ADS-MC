...
partial class SetupForm1
{
    ...
    public Label loadFromFileLabel;
    public Label loadFilepathLabel;
    public TextBox loadFilepathTextbox;
    ...
    private void FormDesignSetup()
    {
        ...
        #region set actual position

        setActualPositionLabel = new Label();
        setActualPositionLabel.Size = new Size(140,40);
        setActualPositionLabel.Location = new Point(650,225);
        ...
        #region load setup from file

        loadFromFileLabel = new Label();
        loadFromFileLabel.Size = new Size(100,40);
        loadFromFileLabel.Location = new Point(650,280);
        loadFromFileLabel.Text = "Load setup data from file:";
        this.Controls.Add(loadFromFileLabel);

        loadFilepathLabel = new Label();
        loadFilepathLabel.Size = new Size(80,20);
        loadFilepathLabel.Location = new Point(800,270);
        loadFilepathLabel.Text = "Filepath:";
        this.Controls.Add(loadFilepathLabel);

        loadFilepathTextbox = new TextBox();
        loadFilepathTextbox.Size = new Size(220,30);
        loadFilepathTextbox.Location = new Point(800,290);
        this.Controls.Add(loadFilepathTextbox);

        loadFromFileButton = new Button();
        loadFromFileButton.Size = new Size(60,30);
        loadFromFileButton.Location = new Point(1040,280);
        loadFromFileButton.Text = "Load";
        ...
        saveToFileLabel.Size = new Size(100,40);
        saveToFileLabel.Location = new Point(650,345);
        saveToFileLabel.Text = "Save setup data to file:";
        this.Controls.Add(saveToFileLabel);

        saveFilepathLabel = new Label();
        saveFilepathLabel.Size = new Size(80,20);
        saveFilepathLabel.Location = new Point(800,335);
        saveFilepathLabel.Text = "Filepath:";
        this.Controls.Add(saveFilepathLabel);

        saveFilepathTextbox = new TextBox();
        saveFilepathTextbox.Size = new Size(220,30);
        saveFilepathTextbox.Location = new Point(800,355);
        this.Controls.Add(saveFilepathTextbox);

        saveToFileButton = new Button();
        saveToFileButton.Size = new Size(60,30);
        saveToFileButton.Location = new Point(1040,345);
